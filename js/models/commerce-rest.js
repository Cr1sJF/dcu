   ...
   function (resolve, reject) {
	 ...
	 self.request({
	   ...
	   callback: function (err, response) {
		 ...
		 var accessToken = Buffer.isBuffer(response) ? JSON.parse(response.toString()).access_token : response.access_token;
...
CommerceSDK.prototype.logout = function () {
 ...
 var logoutPromise = new Promise(
   function (resolve, reject) {
	 ...
	 self.post({
	   url: '/ccadmin/v1/logout', data: {}, callback: function (err, response) {
...
CommerceSDK.prototype.isValidToken = function () {
 ...
 var validPromise = new Promise(
   function (resolve, reject) {
	 ...
	 self.request({
	   url: '/ccadmin/v1/verify', method: 'post', data: requestData, callback: function (err, response) {
